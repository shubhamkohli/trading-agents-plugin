...
Fetch data:
```bash
uv run --project . python scripts/fetch_market_data.py --ticker '$TICKER' --type technical --date '$TODAY'
```
...
Fetch data:
```bash
uv run --project . python scripts/fetch_market_data.py --ticker '$TICKER' --type news --date '$TODAY'
```
...
Fetch data:
```bash
uv run --project . python scripts/fetch_market_data.py --ticker '$TICKER' --type fundamentals --date '$TODAY'
```
...
Fetch data:
```bash
uv run --project . python scripts/fetch_market_data.py --ticker MACRO --type macro --date '$TODAY'
```
